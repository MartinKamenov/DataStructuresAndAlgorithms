...
namespace DSA_CSharp.src.Sorting
{
    ...
    {
        /// <summary>
        /// Uses merge sort to sort elements in array
        /// </summary>
        public static T[] MergeSortWithoutAllocatingArray(T[] arr)
        {
            return MergeSortWithoutAllocatingArray(0, arr.Length, arr);
        }
        ...
        */
        /// <summary>
        /// Uses merge sort to sort elements in array, given start and end for sorting part
        /// </summary>
